    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">CrypAI</h3>
            <p className="mb-4">
              Advanced cryptocurrency analysis powered by artificial intelligence. 
              Making data-driven investment decisions accessible to everyone.
            </p>
          ...
          <div>
            ...
            <p className="mb-4">Subscribe to our newsletter for the latest crypto insights.</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p>© {currentYear} CrypAI. All rights reserved.</p>
